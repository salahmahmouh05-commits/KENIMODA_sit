(function(){
  ...
  function renderGallery(){
    ...
    images.forEach((src, idx) => {
      ...
      t.innerHTML = `<img src="${src}" alt="Miniature ${idx+1} — Ensemble Brodé Femme Premium" width="74" height="92" loading="lazy" decoding="async">`;
      ...
      try {
        ...
        if (res.ok){
          ...
          window.dataLayer.push({
            ...
            product_name: "Ensemble Brodé Femme Premium",
            product_price: 590,
            currency: "MAD",
            country: "Morocco",
